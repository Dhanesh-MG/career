...
export default function SetupPage() {
  ...
  const handleCreateAllUsers = async () => {
    const users = [
      { data: adminData, role: "admin" as const },
      { data: hrData, role: "hr" as const },
      { data: managerData, role: "manager" as const },
    ];
  ...
  const handleInputChange = (
    ...
    setter: React.Dispatch<React.SetStateAction<typeof adminData>>
  ) => {
    setter((prev) => ({
      ...prev,
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Your admin users have been created successfully
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <Alert>
              <AlertDescription>
                You can now log in to the admin panel using any of the created
                accounts. The database has also been seeded with sample job
                postings.
              </AlertDescription>
            </Alert>
      ...
      <div className="w-full max-w-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Create your admin users to get started
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Set up the initial admin users for your career portal. You can
              modify these details before creating the accounts.
            </CardDescription>
          </CardHeader>
